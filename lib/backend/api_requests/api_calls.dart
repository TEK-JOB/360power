...
class MercadoPagoGroup {
  ...
  static CriarPrefernciaCall criarPrefernciaCall = CriarPrefernciaCall();
}

class CriarPrefernciaCall {
  Future<ApiCallResponse> call() async {
    final baseUrl = MercadoPagoGroup.getBaseUrl();

    return ApiManager.instance.makeApiCall(
      callName: 'Criar preferncia',
      apiUrl: '$baseUrl/checkout/preferences',
