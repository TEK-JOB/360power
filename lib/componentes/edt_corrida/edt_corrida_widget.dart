...
class EdtCorridaWidget extends StatefulWidget {
  const EdtCorridaWidget({
    super.key,
  ...
  final CorridasRecord? corrida;

  @override
  State<EdtCorridaWidget> createState() => _EdtCorridaWidgetState();
}

class _EdtCorridaWidgetState extends State<EdtCorridaWidget>
    with TickerProviderStateMixin {
  late EdtCorridaModel _model;
