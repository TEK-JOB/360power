...
class ListComercioWidget extends StatefulWidget {
  const ListComercioWidget({super.key});

  @override
  State<ListComercioWidget> createState() => _ListComercioWidgetState();
}

class _ListComercioWidgetState extends State<ListComercioWidget>
    with TickerProviderStateMixin {
  late ListComercioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListComercioModel());
