...
class EdtAjudaWidget extends StatefulWidget {
  const EdtAjudaWidget({
    super.key,
    required this.ajudaPg,
  });

  final AjudaRecord? ajudaPg;

  @override
  State<EdtAjudaWidget> createState() => _EdtAjudaWidgetState();
}

class _EdtAjudaWidgetState extends State<EdtAjudaWidget>
    with TickerProviderStateMixin {
  late EdtAjudaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EdtAjudaModel());
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Altere os dados necessários depois salve',
