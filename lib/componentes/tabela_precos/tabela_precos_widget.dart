...
class TabelaPrecosWidget extends StatefulWidget {
  const TabelaPrecosWidget({
    super.key,
    required this.bairroComercio,
  });

  final BairroRecord? bairroComercio;

  @override
  State<TabelaPrecosWidget> createState() => _TabelaPrecosWidgetState();
}

class _TabelaPrecosWidgetState extends State<TabelaPrecosWidget>
    with TickerProviderStateMixin {
  late TabelaPrecosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TabelaPrecosModel());
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return SingleChildScrollView(
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: List.generate(rotasDoBairro.length,
                                      (rotasDoBairroIndex) {
