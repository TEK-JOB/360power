...
class CadAjudaWidget extends StatefulWidget {
  const CadAjudaWidget({super.key});

  @override
  State<CadAjudaWidget> createState() => _CadAjudaWidgetState();
}

class _CadAjudaWidgetState extends State<CadAjudaWidget>
    with TickerProviderStateMixin {
  late CadAjudaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadAjudaModel());
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Digite a rua e a ajuda depois salve',
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await AjudaRecord.collection
                                        .doc()
                                        .set(createAjudaRecordData(
                                          rua: _model.ruaTextController.text,
                                          ajuda:
                                              _model.ajudafTextController.text,
                                        ));
                                    Navigator.pop(context);
                                  },
                                  text: 'Salvar',
