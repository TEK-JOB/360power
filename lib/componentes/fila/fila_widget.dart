...
class FilaWidget extends StatefulWidget {
  const FilaWidget({super.key});

  @override
  State<FilaWidget> createState() => _FilaWidgetState();
}

class _FilaWidgetState extends State<FilaWidget> with TickerProviderStateMixin {
  late FilaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilaModel());
                            ...
                            if (valueOrDefault<bool>(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    if ((valueOrDefault<bool>(
                                                currentUserDocument?.impedido,
                                                false) ==
                                            false) &&
                                        (valueOrDefault<bool>(
                                                currentUserDocument?.nafila,
                                                false) ==
                                            false))
                                      Align(
                                        alignment:
                                  ...
                                  builder: (context) {
                                    ...
                                    return SingleChildScrollView(
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children:
                                            List.generate(filaDoPonto.length,
                                                (filaDoPontoIndex) {
                                          final filaDoPontoItem =
                                                          ...
                                                          child: Image.network(
                                                            valueOrDefault<
                                                              ...
                                                              userList5UsersRecord
                                                                  .photoUrl,
                                                              'https://firebasestorage.googleapis.com/v0/b/power-zxvlh8.appspot.com/o/usre360.png?alt=media&token=4bb239e7-3698-4030-be71-d0e0e248548ahttps://firebasestorage.googleapis.com/v0/b/power-zxvlh8.appspot.com/o/usre360.png?alt=media&token=4bb239e7-3698-4030-be71-d0e0e248548a',
                                                            ),
                                                            width: 36.0,
                                                            height: 36.0,
                                                            fit: BoxFit.contain,
