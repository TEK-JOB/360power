...
class CadCorrida2Widget extends StatefulWidget {
  const CadCorrida2Widget({
    super.key,
  ...
  @override
  State<CadCorrida2Widget> createState() => _CadCorrida2WidgetState();
}

class _CadCorrida2WidgetState extends State<CadCorrida2Widget>
    with TickerProviderStateMixin {
  late CadCorrida2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadCorrida2Model());
