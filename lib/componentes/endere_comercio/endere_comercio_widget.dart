...
class EndereComercioWidget extends StatefulWidget {
  const EndereComercioWidget({
    super.key,
    required this.comercio,
  });

  final DocumentReference? comercio;

  @override
  State<EndereComercioWidget> createState() => _EndereComercioWidgetState();
}

class _EndereComercioWidgetState extends State<EndereComercioWidget>
    with TickerProviderStateMixin {
  late EndereComercioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EndereComercioModel());
    ...
    _model.bairroClienteFocusNode ??= FocusNode();

    _model.ruaClienteFocusNode ??= FocusNode();

    _model.numEndClienteFocusNode ??= FocusNode();

    _model.cepFocusNode1 ??= FocusNode();

    _model.cepFocusNode2 ??= FocusNode();
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<BairroRecord>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final containerBairroRecord = snapshot.data!;
                                                              ...
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  child:
                                                                      TextFormField(
                                                                    controller:
                                                                        _model.bairroClienteTextController ??=
                                                                            TextEditingController(
                                                                      text: containerBairroRecord
                                                                          .nome,
                                                                    ),
                                                                    focusNode:
                                                                        _model
                                                                            .bairroClienteFocusNode,
                                                                    autofocus:
                                                                        false,
                                                                    readOnly:
                                                                        true,
                                                                    ...
                                                                    minLines: 1,
                                                                    validator: _model
                                                                        .bairroClienteTextControllerValidator
                                                                        .asValidator(
                                                                            context),
                                                                  ),
                                                                ),
