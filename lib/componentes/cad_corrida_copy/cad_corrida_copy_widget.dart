...
import 'cad_corrida_copy_model.dart';
export 'cad_corrida_copy_model.dart';

class CadCorridaCopyWidget extends StatefulWidget {
  const CadCorridaCopyWidget({
    super.key,
  ...
  @override
  State<CadCorridaCopyWidget> createState() => _CadCorridaCopyWidgetState();
}

class _CadCorridaCopyWidgetState extends State<CadCorridaCopyWidget>
    with TickerProviderStateMixin {
  late CadCorridaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadCorridaCopyModel());
                                                                        ...
                                                                        _model
                                                                          ...
                                                                          () async {
                                                                            _model.docBairroDestino =
                                                                                containerBairroRecordList.where((e) => e.nome == _model.bairroSelectedOption).toList().first;
                                                                            setState(() {});
                                                                            _model.acheiRota2 =
                                                                                await queryRotaRecordOnce(
                                                                              parent: currentUserDocument?.ponto,
                                                                              queryBuilder: (rotaRecord) => rotaRecord.where(
                                                                                'CodigoRota',
                                                          ...
                                                          children: [
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        await corridasRecordReference
                                                                          ...
                                                                          ...createCorridasRecordData(
                                                                            comercio:
                                                                                widget.comercio?.reference,
                                                                            ponto:
                                                                                currentUserDocument?.ponto,
                                                                            status:
                                                                                'Agendada',
                                                                            detalhe:
                                                                                _model.detalhesTextController.text,
                                                                            cancelado:
                                                                                false,
                                                                            concluido:
                                                                                false,
                                                                            ...
                                                                            valorCorrida:
                                                                                _model.rotaAchada?.rotaPreco,
                                                                            valorProduto:
                                                                                double.tryParse(_model.prcoPedidoTextController.text),
                                                                            zap:
                                                                                functions.limpaCamposTelefone(_model.foneTextController.text),
                                                                            nomeComercio:
                                                                                valueOrDefault<String>(
                                                                          ...
                                                                          ...mapToFirestore(
                                                                            {
                                                                              'AggendadoEm': FieldValue.serverTimestamp(),
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Builder(
                                                                builder:
                                                                    (context) {
                                                                  final userfila = containerUsersRecordList
                                                                      .where((e) =>
                                                                          e.nafila)
                                                                      .toList();
                                                                  return Column(
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            await userfilaItem.reference.update(createUsersRecordData(
                                                                              nafila: false,
                                                                              impedido: true,
                                                                              escolhido: true,
                                                                            ));
