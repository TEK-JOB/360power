...
class MeusComerciosWidget extends StatefulWidget {
  const MeusComerciosWidget({super.key});

  @override
  State<MeusComerciosWidget> createState() => _MeusComerciosWidgetState();
}

class _MeusComerciosWidgetState extends State<MeusComerciosWidget>
    with TickerProviderStateMixin {
  late MeusComerciosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeusComerciosModel());
                                                              ...
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                        (context) {
                                                                      final comerciosDoPonto = containerPontoRecord
                                                                          .listComercios
                                                                          .toList();
                                                                      return Wrap(
                                                                        spacing:
                                                                        ...
                                                                        children: List.generate(
                                                                            comerciosDoPonto.length,
                                                                            (comerciosDoPontoIndex) {
                                                                          final comerciosDoPontoItem =
                                                                          ...
                                                                          return Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              builder: (context, snapshot) {
                                                                                ...
                                                                                final stackComerciosRecord = snapshot.data!;
                                                                                return InkWell(
                                                                                  splashColor: Colors.transparent,
                                                                                  focusColor: Colors.transparent,
                                                                                  hoverColor: Colors.transparent,
                                                                                  ...
                                                                                  onTap: () async {
                                                                                    context.pushNamed(
                                                                                      'VerComercio',
                                                                                      queryParameters: {
                                                                                        'comercioSelect': serializeParam(
                                                                                          stackComerciosRecord,
                                                                                          ParamType.Document,
                                                                                        ),
                                                                                      }.withoutNulls,
                                                                                      extra: <String, dynamic>{
                                                                                        'comercioSelect': stackComerciosRecord,
                                                                                      },
                                                                                    );
                                                                                  },
                                                                                  child: SizedBox(
