...
import 'meus_comercios2_model.dart';
export 'meus_comercios2_model.dart';

class MeusComercios2Widget extends StatefulWidget {
  const MeusComercios2Widget({super.key});

  @override
  State<MeusComercios2Widget> createState() => _MeusComercios2WidgetState();
}

class _MeusComercios2WidgetState extends State<MeusComercios2Widget>
    with TickerProviderStateMixin {
  late MeusComercios2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeusComercios2Model());
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            body: Row(
              ...
              children: [
                if ((valueOrDefault(currentUserDocument?.tipo, '') ==
                        'gestor') &&
